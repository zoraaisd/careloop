...
const tasks = [
  'Approve doctor onboarding',
  'Review consultation analytics',
        ...
        <div className="rounded-[32px] border border-white/70 bg-white/85 p-6 shadow-2xl shadow-slate-200/50 backdrop-blur sm:p-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-7 text-slate-500">
                Oversee staff performance, operational health, and system activity across Meditracker.
              </p>
            </div>
            <a
          ...
          <div className="mt-8 grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
            <section className="rounded-[28px] bg-gradient-to-br from-[#0F172A] via-[#10233D] to-[#1565D8] p-6 text-white">
              <p className="text-sm text-blue-100">Operational snapshot</p>
            ...
            <section className="rounded-[28px] border border-slate-100 bg-white p-6">
              ...
              <div className="mt-5 space-y-4">
                {[
                  'Doctor onboarding approvals are waiting for review.',
                  'Department performance reports were refreshed today.',
                  'System monitoring shows normal platform activity.',
                ].map((item) => (
