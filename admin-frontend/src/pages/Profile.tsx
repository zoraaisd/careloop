...
const Profile = () => {
  ...
  return (
    <section className="rounded-none border border-emerald-100 bg-white p-5 shadow-sm transition duration-200 hover:border-emerald-300 hover:shadow-md">
      ...
      <div className="mt-5 grid gap-8 lg:grid-cols-[260px_1fr]">
        <div className="flex min-h-[300px] flex-col items-center justify-center rounded-none border border-emerald-100 bg-emerald-50/30 p-5 text-center">
          {profileImageUrl ? (
            <img
              alt="Admin profile"
          ...
          {isEditing ? (
            <>
              <label
                className="mt-4 inline-flex cursor-pointer items-center justify-center rounded-md bg-emerald-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-emerald-700"
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-none border border-emerald-100 p-4 transition duration-200 hover:border-emerald-300 hover:shadow-sm">
            <p className="text-xs uppercase tracking-wide text-slate-500">Admin Name</p>
            {isEditing ? (
              <input
                className="mt-2 w-full rounded-md border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-emerald-500 focus:outline-none"
          ...
          <div className="rounded-none border border-emerald-100 p-4 transition duration-200 hover:border-emerald-300 hover:shadow-sm sm:col-span-2">
