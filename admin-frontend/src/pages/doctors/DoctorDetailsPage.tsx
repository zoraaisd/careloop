    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-emerald-100 bg-white p-6 shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <button
            className="rounded-xl bg-emerald-600 px-6 py-2 text-sm font-semibold text-white transition hover:bg-emerald-700 shadow-sm"
            onClick={() => navigate(`/admin/doctors/${doctorId}/checkout`)}
            type="button"
          >
            Upgrade Plan
          </button>
        ...
        <div className="mt-5 rounded-2xl border border-slate-200 bg-slate-50/60 p-5">
          <div className="grid gap-x-8 gap-y-6 md:grid-cols-2">
            ...
            >
              ...
              <p className="mt-1 text-sm font-bold text-emerald-700 group-hover:text-emerald-800 flex items-center gap-1">
