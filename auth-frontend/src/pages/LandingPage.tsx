    ...
    <div className="min-h-screen">
        ...
        <section className="relative overflow-hidden">
          <div className="mx-auto grid max-w-7xl gap-14 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-24">
            <div className="max-w-2xl">
              <div className="inline-flex rounded-full border border-blue-100 bg-white/80 px-4 py-2 text-sm font-medium text-[#1565D8] shadow-sm">
              ...
              <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
                Meditracker helps healthcare teams manage patients, doctors, and
            ...
            <div className="relative">
              <div className="absolute inset-x-8 top-6 h-32 rounded-full bg-blue-300/20 blur-3xl" />
              <div className="relative rounded-[32px] border border-white/60 bg-slate-950 p-4 shadow-2xl shadow-blue-900/15">
                <div className="rounded-[28px] bg-gradient-to-br from-slate-900 via-slate-900 to-[#11345f] p-6 text-white">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <p className="text-sm text-blue-100">Today at Meditracker</p>
                  ...
                  <div className="mt-8 grid gap-4 sm:grid-cols-2">
                    ...
                    <div className="rounded-3xl bg-white/10 p-5">
                      <p className="text-sm text-blue-100">Doctors Available</p>
                    ...
                    <div className="rounded-3xl bg-white/10 p-5 sm:col-span-2">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-blue-100">Patient satisfaction</p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {features.map((feature, index) => (
              <article
                ...
                key={feature.title}
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 text-lg font-bold text-[#2D8CFF]">
                  0{index + 1}
                </div>
      ...
      <footer className="border-t border-white/60 bg-white/70 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-8 text-sm text-slate-500 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
          <p>© 2026 Meditracker. Smarter healthcare coordination.</p>
